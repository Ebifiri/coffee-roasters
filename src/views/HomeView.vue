  ...
  <div class="overflow-x-hidden">
    <section class="w-full h-full rounded-xl bg-[url('../assets/home/desktop/image-hero-coffeepress.jpg')] bg-cover">
      <section class="flex flex-col items-center 2xl:items-start 2xl:w-1/2 p-10 2xl:p-0 2xl:px-20 2xl:py-32 space-y-14">
        ...
        <section class="pb-20 2xl:pb-0">
          <router-link to="/createplan">
            <button class="bg-dark-green text-white font-fraunces font-bold px-10 py-3 rounded text-lg hover:bg-active-teal">Create your plan</button>
          </router-link>
        </section>
      </section>
    </section>
    <section class="my-40 2xl:my-0">
      <section class="2xl:py-40 2xl:px-20 grid grid-rows-4 space-y-10 2xl:space-y-0 2xl:grid-cols-4 gap-3">
        ...
        <section class="flex flex-col items-center">
          <img src="../assets/home/desktop/image-planalto.png" class="w-1/2 2xl:w-3/4">
        ...
        <section class="flex flex-col items-center">
          <img src="../assets/home/desktop/image-piccollo.png" class="w-1/2 2xl:w-3/4">
        ...
        <section class="flex flex-col items-center">
          <img src="../assets/home/desktop/image-danche.png" class="w-1/2 2xl:w-3/4">
    ...
    <section class="h-[1500px] 2xl:h-[810px] flex flex-col items-center 2xl:items-start">
      <section class="flex flex-col items-center h-4/5 w-full bg-light-black rounded-xl">
        ...
        <section class="grid grid-rows-3 2xl:grid-cols-3 gap-8 place-items-center w-3/4">
          <section class="flex flex-col items-center relative py-20 bg-teal rounded-xl space-y-8">
            <section class="">
            ...
            <p class="font-barlow text-lg text-center px-10 text-white"> Discover an endless variety of the world’s best artisan coffee from each of our roasters.</p>
          </section>
          <section class="flex flex-col items-center relative py-20 bg-teal rounded-xl space-y-8">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-20 h-20">
            ...
            <p class="font-fraunces text-3xl font-bold text-white text-center">Exclusive benefits</p>
            <p class="font-barlow text-lg text-center px-10 text-white">Special offers and swag when you subscribe, including 30% off your first shipment.</p>
          </section>
          <section class="flex flex-col items-center py-20 bg-teal rounded-xl space-y-8">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-20 h-20">
            ...
            <p class="font-barlow text-lg text-center px-10 text-white">We cover the cost and coffee is delivered fast. Peak freshness: guaranteed.</p>
          </section>
        </section>
      </section>
    </section>
